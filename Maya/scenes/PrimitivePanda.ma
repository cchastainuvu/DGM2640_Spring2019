...
//Last modified: Thu, Jan 31, 2019 02:44:58 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.8014784951952389 2.8531913638395126 8.6634443868257236 ;
	setAttr ".r" -type "double3" -12.338352727394309 -716.20000000010032 -1.9922266493725353e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "0D21308D-449C-5BAA-9142-A2A7FE0607DD";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 8.5770112611625624;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.375 0.03125 ;
	...
	setAttr -s 22 ".pt";
	setAttr ".pt[113]" -type "float3" 0 0 0.031775992 ;
	setAttr ".pt[130]" -type "float3" 0 0 -0.0056254924 ;
	setAttr ".pt[131]" -type "float3" -0.047271293 0 -0.0010258034 ;
	setAttr ".pt[134]" -type "float3" -0.024626657 0 0 ;
	setAttr ".pt[147]" -type "float3" -0.035254288 0 0 ;
	setAttr ".pt[150]" -type "float3" -0.031702988 0 0 ;
	setAttr ".pt[491]" -type "float3" 0 0 0.043462895 ;
	setAttr ".pt[564]" -type "float3" 0 2.220446e-16 -0.031865075 ;
	setAttr ".pt[565]" -type "float3" 0 -2.220446e-16 -0.032747373 ;
	setAttr ".pt[566]" -type "float3" 0 0 -0.036372859 ;
	setAttr ".pt[567]" -type "float3" 0 0 -0.049545791 ;
	setAttr ".pt[568]" -type "float3" 0 0 -0.033523832 ;
	setAttr ".pt[574]" -type "float3" 0 0 0.028069638 ;
	setAttr ".pt[575]" -type "float3" 0 0 0.031915314 ;
	setAttr ".pt[576]" -type "float3" 0.018232604 0 0.044642933 ;
	setAttr ".pt[649]" -type "float3" 0 2.220446e-16 -0.051306434 ;
	setAttr ".pt[650]" -type "float3" 0 -2.220446e-16 -0.032747373 ;
	setAttr ".pt[651]" -type "float3" 0 0 -0.036372859 ;
	setAttr ".pt[652]" -type "float3" 0 0 -0.049545791 ;
	setAttr ".pt[653]" -type "float3" 0 0 -0.033523832 ;
	setAttr ".pt[655]" -type "float3" 0 0 0.065440163 ;
	setAttr ".pt[656]" -type "float3" 0 0 0.051198579 ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7D501822-4655-4A79-2F69-67A355156B99";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C0E73F9E-46C0-141E-3FC4-499E59D79FE0";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "5F5592CD-4CDB-15C6-A88A-0DBF91BAD310";
createNode displayLayerManager -n "layerManager";
	rename -uid "F67A3DD1-4993-A764-C617-1D96294526F4";
createNode displayLayer -n "defaultLayer";
	rename -uid "EDDC717E-432D-398C-57F9-F49CBF21B604";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "311B1C22-4CE2-B0E9-41D5-8286D38BD9BA";
